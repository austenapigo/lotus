...
dat <- read.csv("example_dat copy.csv", row.names = 1, header = TRUE)
...
((1/N) * 
   ((p11^0.000000001 + p12^0.000000001 + p13^0.000000001) + (p21^0.000000001 + p22^0.000000001 + p23^0.000000001) + (p31^0.000000001 + p32^0.000000001 + p33^0.000000001)))
# 0.8571429
