...
hs.object <- structural.specificity(comm.matrix, abundance.weighted = TRUE, trim = TRUE)
head(hs.object)
...
null.structural.object <- null.structural(comm.matrix, iterations = 100, abundance.weighted = TRUE, randomization.method = "shuffle.web", trim = TRUE, notify = TRUE)
...
structural.dev <- relative.structural(comm.matrix, randomized = null.structural.object, model = "first", abundance.weighted = TRUE, trim = TRUE, notify = TRUE)
